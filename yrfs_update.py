...
if __name__ == '__main__':
    ...
    SERVER = ["192.168.11.196","192.168.11.197","192.168.11.198","192.168.11.199"]
    ...
    stop = ["systemctl stop yrfs-client","systemctl stop yrfs-mgmtd","systemctl stop yrfs-storage","systemctl stop yrfs-admon"]
    ...
    if meta_nums == '1':
        if version_stat == 0:
            ...
            meta_service_cmd = "yrfs-meta@mds.service"
        else:
            repo_bak = ['mkdir -p /etc/yum.repos.d/cy_bak','mv /etc/yum.repos.d/*.repo /etc/yum.repos.d/cy_bak','echo -e "[yrcf-6.4]\nname=yrcf-6.4\nenabled=1\nbaseurl=http://192.168.0.22:17283\ngpgcheck=0" > /etc/yum.repos.d/yrcf.repo']
            meta_service_cmd = "yrfs-meta@mds0.service"
    else:
